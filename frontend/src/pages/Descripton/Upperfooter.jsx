...
const Upperfooter = () => {
  return (
    <>
      <Wrapper className="last-sec-div1" style={{ padding: "1rem 2rem" }}>
        <h3>
        ...
        <p>
          ...
          separately? You can simply upload your prescription and we will place
          your order for you. And there is more! At Tata 1mg, you can buy health
          products and medicines online at best discounts.
        </p>
        <p>
